...
image::/images/pipeline-technologies.png[CI/CD Technologies]
...
image::/images/pipeline-jenkins-credentials.png[Login with OpenShift]
...
image::/images/pipeline-jenkins-permissions.png[Grant Jenkins Permissions]
...
[source]
----
oc set triggers dc/nationalparks --from-image --remove
----
