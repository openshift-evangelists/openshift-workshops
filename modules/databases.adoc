...
[source]
----
oc env dc nationalparks -e SPRING_DATA_MONGODB_USERNAME=mongodb -e SPRING_DATA_MONGODB_PASSWORD=mongodb -e SPRING_DATA_MONGODB_DATABASE=mongodb -e SPRING_DATA_MONGODB_HOST=mongodb
----
