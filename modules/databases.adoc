...
[source]
----
oc env dc nationalparks -e SPRING_DATA_MONGODB_USER=mongodb -e SPRING_DATA_MONGODB_PASSWORD=mongodb -e SPRING_DATA_MONGODB_DATABASE=mongodb
----
...
SPRING_DATA_MONGODB_USER=mongodb
