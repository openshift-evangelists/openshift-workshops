...
In this lab, we're going to deploy the web component of the ParksMap application which uses OpenShift service discovery mechanism to discover the backend services deployed and shows their data on the map.
