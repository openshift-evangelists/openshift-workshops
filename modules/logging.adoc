...
`parksmap-1-hx0kv` and in the *Project* (namespace) explore{{USER_SUFFIX}}. 

[source]
----
kubernetes_pod_name:"parksmap-1-hx0kv" AND kubernetes_namespace_name:"explore{{USER_SUFFIX}}"
----
