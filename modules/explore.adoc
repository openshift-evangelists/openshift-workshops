...
The first thing we want to do is switch to the *explore{{USER_SUFFIX}}* project. You
...
*explore{{USER_SUFFIX}}* project, you will be taken to the project overview page
