...
[source]
----
Now using project "explore{{USER_SUFFIX}}" on server "https://{{CONSOLE_ADDRESS}}".
----
...
Click on the *explore{{USER_SUFFIX}}* project. When you click on the
*smoke{{USER_SUFFIX}}* project, you will be taken to the project overview page
which will list all of the routes, services, deployments, and pods that you have
running as part of your project.  For this example, you will see a frontend that
is deployed to two pods.
