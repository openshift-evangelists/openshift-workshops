# Module: Containerized Microservices
...
image::/images/demo/msa-coolstore-web.png[CoolStore Web UI,width=920,align=center]
...
image::/images/demo/msa-eap-logs.png[JBoss EAP Container Logs,width=920,align=center]
...
image::/images/demo/msa-jws-logs.png[JBoss Web Server Container Logs,width=920,align=center]
